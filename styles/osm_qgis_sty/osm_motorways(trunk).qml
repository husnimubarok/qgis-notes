...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="2e+06" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="2000000" filter="type like 'trunk%'" symbol="0" scalemindenom="1000000" label="Trunk Road 1:1,000,000 to 1:2,000,000"/>
      <rule scalemaxdenom="1000000" filter="type like 'trunk%'" symbol="1" scalemindenom="500000" label="Trunk Road 1:500,000 to 1:1,000,000"/>
      <rule scalemaxdenom="500000" filter="type like 'trunk%'" symbol="2" scalemindenom="150000" label="Trunk Road 1:150,000 to 1:500,000"/>
      <rule scalemaxdenom="150000" filter="type like 'trunk%'" symbol="3" scalemindenom="1" label="Trunk Road 1:1 to 1:150,000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="152,223,136,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/shapeFillColorB" value="53"/>
    <property key="labeling/shapeFillColorG" value="185"/>
    <property key="labeling/shapeFillColorR" value="93"/>
