...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="250000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="250000" filter="type='motorway_junction' and ref is not null" symbol="0" scalemindenom="1" label="Transport Points Junction 1:1 to 1:250,000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="133,246,194,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/shapeFillColorG" value="127"/>
    <property key="labeling/shapeFillColorR" value="127"/>
