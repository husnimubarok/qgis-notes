...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="1e+06" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="1000000" filter="z_order>=($scale/333333)" symbol="0" scalemindenom="1" label="Places 1:1 to 1:1,000,000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="149,118,171,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Size" value="1~~1~~&quot;z_order&quot; * 3 + 6~~"/>
